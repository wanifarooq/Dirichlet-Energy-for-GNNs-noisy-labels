...
where \( A_{YZ_1}, A_{YZ_2}, A_Z \) are batch aware attention mechanisms modulating signal interactions ~\citep{hlffgnn}. The model minimizes a composite loss:
\[
...
\begin{figure}[htbp]
    ...
    \subfigure[Normalized Dirichlet energy (Y, Z1, Z2)]
    {
        \includegraphics[width=0.45\textwidth]{AISTATS/figures/enzymez1z2y.pdf}
    }
    \hfill
    \subfigure[Dirichlet energy of Y]
    {
        \includegraphics[width=0.45\textwidth]{AISTATS/figures/enzymey.pdf}
    }

    \ \\[1ex]  % <-- This creates a new row with a small vertical gap

    \subfigure[Dirichlet energy of Z1]
    {
        \includegraphics[width=0.45\textwidth]{AISTATS/figures/enzymez1.pdf}
    }
    \hfill
    \subfigure[Dirichlet energy of Z2]
    {
        \includegraphics[width=0.45\textwidth]{AISTATS/figures/enzymez2.pdf}
    }
