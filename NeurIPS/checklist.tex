...
\item {\bf Theory assumptions and proofs}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: Proposition~\ref{prop:dataset_energy} and Theorem~\ref{thm:entropy_link} state assumptions explicitly in the main text, and full proofs are provided in Appendix~\ref{app:proofs}.
