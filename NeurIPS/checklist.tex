...
\item {\bf Theory assumptions and proofs}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: Proposition~\ref{prop:dataset_energy}, Lemmas~\ref{lem:poincare}--\ref{lem:bilip}, and Theorem~\ref{thm:noise_forces_energy} state their assumptions explicitly in the main text, and full proofs are provided in Appendix~\ref{app:proofs}.
